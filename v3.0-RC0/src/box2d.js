...
(function (a2j, undefined) {
    if (!(Object.defineProperty instanceof Function) && Object.prototype.__defineGetter__ instanceof Function && Object.prototype.__defineSetter__ instanceof Function)Object.defineProperty = function (obj, p, cfg) {
...
(function () {
    ...
    b2Collision.CollidePolygons = function (manifold, polyA, xfA, polyB, xfB) {
        ...
        var local_v12;
        if (edge1 + 1 < count1)local_v12 = vertices1[parseInt(edge1 + 1)]; else local_v12 = vertices1[0];
    ...
    Object.defineProperty(b2ContactID.prototype, "key", {enumerable: false, configurable: true, get: function () {
        return this._key
    }});
    Object.defineProperty(b2ContactID.prototype, "key", {enumerable: false, configurable: true, set: function (value) {
        if (value ===
            undefined)value = 0;
        this._key = value;
    ...
    b2DistanceProxy.prototype.GetSupportVertex = function (d) {
        var bestIndex = 0;
        var bestValue =
            this.m_vertices[0].x * d.x + this.m_vertices[0].y * d.y;
        for (var i = 1; i < this.m_count; ++i) {
            var value = this.m_vertices[i].x * d.x + this.m_vertices[i].y * d.y;
            if (value > bestValue) {
                bestIndex = i;
    ...
    b2DynamicTree.prototype.MoveProxy = function (proxy, aabb, displacement) {
        ...
        var extendY = b2Settings.b2_aabbExtension + b2Settings.b2_aabbMultiplier * (displacement.y >
            0 ? displacement.y : -displacement.y);
    ...
    b2DynamicTree.prototype.Rebalance = function (iterations) {
        ...
        for (var i = 0; i < iterations; i++) {
            ...
            while (node.IsLeaf() == false) {
                node = this.m_path >> bit &
                    1 ? node.child2 : node.child1;
                bit = bit + 1 & 31
            }
            ++this.m_path;
    ...
    b2DynamicTreeBroadPhase.prototype.MoveProxy =
        function (proxy, aabb, displacement) {
    ...
    b2DynamicTreeNode.prototype.IsLeaf =
        function () {
    ...
    b2Segment.prototype.ExtendBackward = function (aabb) {
        ...
        var dY = -this.p2.y + this.p1.y;
        var lambda =
            Math.min(dX > 0 ? (aabb.upperBound.x - this.p2.x) / dX : dX < 0 ? (aabb.lowerBound.x - this.p2.x) / dX : Number.POSITIVE_INFINITY, dY > 0 ? (aabb.upperBound.y - this.p2.y) / dY : dY < 0 ? (aabb.lowerBound.y - this.p2.y) / dY : Number.POSITIVE_INFINITY);
    ...
    b2SeparationFunction.prototype.Initialize = function (cache, proxyA, transformA, proxyB, transformB) {
        ...
        if (count == 1) {
            ...
            if (s == 0 || s == 1) {
                ...
                tMat = transformA.R;
                pointAX = transformA.position.x + (tMat.col1.x * tVec.x + tMat.col2.x * tVec.y);
                pointAY = transformA.position.y + (tMat.col1.y *
                    tVec.x + tMat.col2.y * tVec.y);
    ...
    b2SeparationFunction.prototype.Evaluate = function (transformA, transformB) {
        ...
        switch (this.m_type) {
            ...
            case b2SeparationFunction.e_faceA:
                normal = b2Math.MulMV(transformA.R,
                    this.m_axis);
    ...
    b2Simplex.prototype.GetSearchDirection = function () {
        switch (this.m_count) {
            ...
            case 2:
                ...
                if (sgn > 0)return b2Math.CrossFV(1, e12); else return b2Math.CrossVF(e12, 1);
            default:
                b2Settings.b2Assert(false);
                return new b2Vec2
        }
    ...
    b2Simplex.prototype.GetWitnessPoints = function (pA, pB) {
        switch (this.m_count) {
            ...
            case 3:
                ...
                pB.y = pA.y = this.m_v1.a * this.m_v1.wA.y +
                    this.m_v2.a * this.m_v2.wA.y + this.m_v3.a * this.m_v3.wA.y;
                break;
            default:
                b2Settings.b2Assert(false);
                break
    ...
    b2TimeOfImpact.TimeOfImpact = function (input) {
        ...
        for (; ;) {
            ...
            if (iter == 0)if (separation > radius)target = b2Math.Max(radius - tolerance, 0.75 * radius); else target = b2Math.Max(separation - tolerance, 0.02 * radius);
            ...
            for (; ;) {
                var x = 0;
                if (rootIterCount & 1)x = x1 + (target - f1) * (x2 - x1) / (f2 - f1); else x = 0.5 * (x1 + x2);
    ...
    Object.defineProperty(Features.prototype, "referenceEdge", {enumerable: false, configurable: true,
        get: function () {
            return this._referenceEdge
        }});
    Object.defineProperty(Features.prototype, "referenceEdge", {enumerable: false, configurable: true, set: function (value) {
        if (value === undefined)value = 0;
        this._referenceEdge = value;
        this._m_id._key = this._m_id._key & 4294967040 | this._referenceEdge & 255
    }});
    Object.defineProperty(Features.prototype, "incidentEdge", {enumerable: false, configurable: true, get: function () {
        return this._incidentEdge
    }});
    Object.defineProperty(Features.prototype, "incidentEdge", {enumerable: false, configurable: true,
        set: function (value) {
            if (value === undefined)value = 0;
            this._incidentEdge = value;
            this._m_id._key = this._m_id._key & 4294902015 | this._incidentEdge << 8 & 65280
        }});
    Object.defineProperty(Features.prototype, "incidentVertex", {enumerable: false, configurable: true, get: function () {
        return this._incidentVertex
    }});
    Object.defineProperty(Features.prototype, "incidentVertex", {enumerable: false, configurable: true, set: function (value) {
        if (value === undefined)value = 0;
        this._incidentVertex = value;
        this._m_id._key = this._m_id._key & 4278255615 |
            this._incidentVertex << 16 & 16711680
    }});
    Object.defineProperty(Features.prototype, "flip", {enumerable: false, configurable: true, get: function () {
        return this._flip
    }});
    Object.defineProperty(Features.prototype, "flip", {enumerable: false, configurable: true, set: function (value) {
        if (value === undefined)value = 0;
        this._flip = value;
...
(function () {
    ...
    Object.defineProperty(b2Color.prototype, "r", {enumerable: false, configurable: true,
        set: function (rr) {
            if (rr === undefined)rr = 0;
            this._r = Box2D.parseUInt(255 * b2Math.Clamp(rr, 0, 1))
        }});
    Object.defineProperty(b2Color.prototype, "g", {enumerable: false, configurable: true, set: function (gg) {
        if (gg === undefined)gg = 0;
        this._g = Box2D.parseUInt(255 * b2Math.Clamp(gg, 0, 1))
    }});
    Object.defineProperty(b2Color.prototype, "b", {enumerable: false, configurable: true, set: function (bb) {
        if (bb === undefined)bb = 0;
        this._b = Box2D.parseUInt(255 * b2Math.Clamp(bb, 0, 1))
    }});
    Object.defineProperty(b2Color.prototype, "color", {enumerable: false,
...
(function () {
    ...
    b2Body.prototype.Split = function (callback) {
        ...
        for (var f = body1.m_fixtureList; f;)if (callback(f)) {
            var next = f.m_next;
            if (prev)prev.m_next = next; else body1.m_fixtureList = next;
    ...
    b2Body.prototype.SetBullet = function (flag) {
        if (flag)this.m_flags |= b2Body.e_bulletFlag; else this.m_flags &= ~b2Body.e_bulletFlag
    };
    ...
    b2Island.prototype.Solve = function (step, gravity, allowSleep) {
        ...
        for (i = 0; i < this.m_bodyCount; ++i) {
            ...
            if (rotation * rotation > b2Settings.b2_maxRotationSquared)if (b.m_angularVelocity < 0)b.m_angularVelocity = -b2Settings.b2_maxRotation * step.inv_dt; else b.m_angularVelocity = b2Settings.b2_maxRotation * step.inv_dt;
        ...
        if (allowSleep) {
            ...
            if (minSleepTime >= b2Settings.b2_timeToSleep)for (i =
    ...
    b2Island.prototype.SolveTOI = function (subStep) {
        ...
        for (i =
            ...
            if (rotation *
                rotation > b2Settings.b2_maxRotationSquared)if (b.m_angularVelocity < 0)b.m_angularVelocity = -b2Settings.b2_maxRotation * subStep.inv_dt; else b.m_angularVelocity = b2Settings.b2_maxRotation * subStep.inv_dt;
            b.m_sweep.c0.SetV(b.m_sweep.c);
            b.m_sweep.a0 = b.m_sweep.a;
    ...
    b2World.prototype.SetBroadPhase = function (broadPhase) {
        ...
        for (var b = this.m_bodyList; b; b = b.m_next)for (var f = b.m_fixtureList; f; f =
    ...
    b2World.prototype.Step = function (dt, velocityIterations, positionIterations) {
        ...
        if (dt > 0)step.inv_dt = 1 / dt; else step.inv_dt = 0;
    ...
    b2World.prototype.DrawDebugData =
        function () {
            ...
            if (flags & b2DebugDraw.e_controllerBit)for (var c = this.m_controllerList; c; c =
                c.m_next)c.Draw(this.m_debugDraw);
    ...
    b2World.prototype.QueryShape = function (callback, shape, transform) {
        ...
        function WorldQueryWrapper(proxy) {
            var fixture =
                    broadPhase.GetUserData(proxy)instanceof b2Fixture ? broadPhase.GetUserData(proxy) : null;
    ...
    b2World.prototype.Solve = function (step) {
        ...
        island.Initialize(this.m_bodyCount, this.m_contactCount, this.m_jointCount, null,
    ...
    b2World.prototype.SolveTOI = function (step) {
        ...
        for (; ;) {
            var minContact = null;
            var minTOI = 1;
            for (c = this.m_contactList; c; c =
                c.m_next) {
                if (c.IsSensor() == true || c.IsEnabled() == false || c.IsContinuous() == false)continue;
                var toi = 1;
                if (c.m_flags & b2Contact.e_toiFlag)toi = c.m_toi; else {
                    fA = c.m_fixtureA;
                    fB = c.m_fixtureB;
                    bA = fA.m_body;
                    bB = fB.m_body;
                    ...
                    toi =
                        c.ComputeTOI(bA.m_sweep, bB.m_sweep);
...
(function () {
    ...
    b2Contact.prototype.SetSensor = function (sensor) {
        if (sensor)this.m_flags |= b2Contact.e_sensorFlag; else this.m_flags &= ~b2Contact.e_sensorFlag
    };
    ...
    b2Contact.prototype.SetEnabled = function (flag) {
        if (flag)this.m_flags |= b2Contact.e_enabledFlag; else this.m_flags &= ~b2Contact.e_enabledFlag
    };
    ...
    b2Contact.prototype.Update = function (listener) {
        ...
        if (this.m_flags & b2Contact.e_sensorFlag) {
            ...
            if (bodyA.GetType() != b2Body.b2_dynamicBody || bodyA.IsBullet() || bodyB.GetType() != b2Body.b2_dynamicBody || bodyB.IsBullet())this.m_flags |= b2Contact.e_continuousFlag; else this.m_flags &= ~b2Contact.e_continuousFlag;
            if (aabbOverlap) {
                this.Evaluate();
        ...
        if (touching)this.m_flags |= b2Contact.e_touchingFlag; else this.m_flags &= ~b2Contact.e_touchingFlag;
...
(function () {
    var b2Body = Box2D.Dynamics.b2Body, b2BodyDef = Box2D.Dynamics.b2BodyDef, b2ContactFilter = Box2D.Dynamics.b2ContactFilter, b2ContactImpulse = Box2D.Dynamics.b2ContactImpulse, b2ContactListener = Box2D.Dynamics.b2ContactListener, b2ContactManager = Box2D.Dynamics.b2ContactManager, b2DebugDraw = Box2D.Dynamics.b2DebugDraw, b2DestructionListener = Box2D.Dynamics.b2DestructionListener, b2FilterData = Box2D.Dynamics.b2FilterData, b2Fixture = Box2D.Dynamics.b2Fixture, b2FixtureDef = Box2D.Dynamics.b2FixtureDef, b2Island = Box2D.Dynamics.b2Island,
        ...
        b2GravityController = Box2D.Dynamics.Controllers.b2GravityController, b2TensorDampingController = Box2D.Dynamics.Controllers.b2TensorDampingController;
    ...
    b2TensorDampingController.prototype.SetAxisAligned = function (xDamping, yDamping) {
        ...
        if (xDamping > 0 || yDamping > 0)this.maxTimestep = 1 / Math.max(xDamping, yDamping); else this.maxTimestep = 0
    };
...
(function () {
    ...
    b2DistanceJoint.prototype.InitVelocityConstraints = function (step) {
        ...
        if (length > b2Settings.b2_linearSlop)this.m_u.Multiply(1 / length); else this.m_u.SetZero();
    ...
    b2GearJoint.prototype.SolvePositionConstraints = function (baumgarte) {
        ...
        var coordinate1 = 0;
        var coordinate2 = 0;
        if (this.m_revolute1)coordinate1 = this.m_revolute1.GetJointAngle(); else coordinate1 = this.m_prismatic1.GetJointTranslation();
        if (this.m_revolute2)coordinate2 = this.m_revolute2.GetJointAngle(); else coordinate2 = this.m_prismatic2.GetJointTranslation();
    ...
    b2LineJoint.prototype.GetJointSpeed = function () {
        ...
        var speed = dX * -w1 * axis.y + dY * w1 * axis.x + (axis.x * (v2.x + -w2 * r2Y - v1.x - -w1 * r1Y) +
    ...
    b2LineJoint.prototype.InitVelocityConstraints = function (step) {
        ...
        if (this.m_enableLimit) {
            ...
            if (b2Math.Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings.b2_linearSlop)this.m_limitState = b2Joint.e_equalLimits; else if (jointTransition <= this.m_lowerTranslation) {
    ...
    b2LineJoint.prototype.SolveVelocityConstraints = function (step) {
        ...
        if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
            ...
            if (this.m_limitState == b2Joint.e_atLowerLimit)this.m_impulse.y = b2Math.Max(this.m_impulse.y, 0); else if (this.m_limitState ==
                b2Joint.e_atUpperLimit)this.m_impulse.y = b2Math.Min(this.m_impulse.y, 0);
            var b = -Cdot1 - (this.m_impulse.y - f1.y) * this.m_K.col2.x;
            var f2r = 0;
            if (this.m_K.col1.x != 0)f2r = b / this.m_K.col1.x + f1.x; else f2r = f1.x;
            ...
            var df2 = 0;
            if (this.m_K.col1.x != 0)df2 = -Cdot1 / this.m_K.col1.x; else df2 = 0;
    ...
    b2LineJoint.prototype.SolvePositionConstraints =
        function (baumgarte) {
            ...
            if (active) {
                ...
                var impulse1 = 0;
                if (k11 != 0)impulse1 = -C1 / k11; else impulse1 =
                    0;
                impulse.x = impulse1;
                impulse.y = 0
            }
    ...
    b2PrismaticJoint.prototype.GetJointSpeed = function () {
        ...
        var w1 = bA.m_angularVelocity;
        var w2 = bB.m_angularVelocity;
        var speed = dX * -w1 * axis.y +
            dY * w1 * axis.x + (axis.x * (v2.x + -w2 * r2Y - v1.x - -w1 * r1Y) + axis.y * (v2.y + w2 * r2X - v1.y - w1 * r1X));
        return speed
    };
    ...
    b2PrismaticJoint.prototype.SolveVelocityConstraints = function (step) {
        ...
        if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
            ...
            this.m_impulse.Add(df);
            if (this.m_limitState == b2Joint.e_atLowerLimit)this.m_impulse.z = b2Math.Max(this.m_impulse.z, 0); else if (this.m_limitState == b2Joint.e_atUpperLimit)this.m_impulse.z = b2Math.Min(this.m_impulse.z, 0);
    ...
    b2PulleyJoint.prototype.InitVelocityConstraints = function (step) {
        ...
        if (length1 > b2Settings.b2_linearSlop)this.m_u1.Multiply(1 / length1); else this.m_u1.SetZero();
        if (length2 > b2Settings.b2_linearSlop)this.m_u2.Multiply(1 / length2); else this.m_u2.SetZero();
    ...
    b2PulleyJoint.prototype.SolvePositionConstraints = function (baumgarte) {
        ...
        if (this.m_state == b2Joint.e_atUpperLimit) {
            ...
            linearError = b2Math.Max(linearError,
                -C);
    ...
    b2RevoluteJoint.prototype.InitVelocityConstraints = function (step) {
        ...
        if (this.m_enableLimit) {
            ...
            if (b2Math.Abs(this.m_upperAngle - this.m_lowerAngle) < 2 * b2Settings.b2_angularSlop)this.m_limitState = b2Joint.e_equalLimits; else if (jointAngle <= this.m_lowerAngle) {
    ...
    b2RevoluteJoint.prototype.SolveVelocityConstraints = function (step) {
        ...
        if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit) {
            ...
            if (this.m_limitState == b2Joint.e_equalLimits)this.m_impulse.Add(this.impulse3); else if (this.m_limitState == b2Joint.e_atLowerLimit) {
...
if (typeof require !== "undefined" && typeof module !== "undefined")module.exports = Box2D;