            ...
            while (this._particleIdx < this.particleCount) {
                ...
                if (selParticle.timeToLive > 0) {
                    ...
                    if (!this._dontTint || cc._renderType === cc._RENDER_TYPE_CANVAS) {
                        ...
                        selParticle.color.a += 0 | selParticle.deltaColor.a *
                            dt;
    ...
    setDisplayFrame: function (spriteFrame) {
        ...
        for (var i = 0; i < this.particleCount; i++) {
            ...
            if (this.drawMode == cc.ParticleSystem.TEXTURE_MODE) {
                ...
                if (drawElement)context.drawImage(drawElement, 0, 0);
                context.restore()
            } else {
                context.save();
...
if (cc._renderType === cc._RENDER_TYPE_CANVAS && !cc.sys._supportCanvasNewBlendModes)_p._changeTextureColor = function (element, color, rect) {
