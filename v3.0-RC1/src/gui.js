...
cc.Scale9Sprite = cc.Node.extend({_spriteRect: null, _capInsetsInternal: null, _positionsAreDirty: false, _scale9Image: null, _topLeft: null, _top: null, _topRight: null, _left: null, _centre: null, _right: null, _bottomLeft: null, _bottom: null, _bottomRight: null, _colorUnmodified: null, _opacityModifyRGB: false, _originalSize: null, _preferredSize: null, _opacity: 0, _color: null, _capInsets: null, _insetLeft: 0, _insetTop: 0, _insetRight: 0, _insetBottom: 0, _spritesGenerated: false, _spriteFrameRotated: false, _textureLoaded: false, _loadedEventListeners: null,
    _className: "Scale9Sprite", textureLoaded: function () {
        ...
        var insets,
            locInsetLeft = this._insetLeft, locInsetTop = this._insetTop, locInsetRight = this._insetRight;
        ...
        var locBottomLeftContentSize =
            locBottomLeft.getContentSize();
    ...
    setInsetLeft: function (insetLeft) {
        ...
        return this.initWithBatchNode(null, cc.rect(0,
            0, 0, 0), false, cc.rect(0, 0, 0, 0))
        ...
        return this.initWithBatchNode(batchNode, spriteFrame.getRect(), cc._renderType == cc._RENDER_TYPE_WEBGL && spriteFrame.isRotated(),
            capInsets)
        ...
        x += center_w;
        var rightbottombounds = cc.rect(x,
            y, right_w, bottom_h);
        ...
        if (!rotated) {
            ...
            cc._rectApplyAffineTransformIn(centerbottombounds,
                t);
            ...
            this._topRight.initWithTexture(selTexture,
                righttopbounds);
            ...
            rightbottombounds =
                cc.rectApplyAffineTransform(rightbottombounds, t);
            ...
            locScale9Image.addChild(this._right,
                1, cc.Scale9Sprite.POSITIONS_RIGHT);
            this._topLeft = new cc.Sprite;
            ...
            locScale9Image.addChild(this._bottomLeft,
                2, cc.Scale9Sprite.POSITIONS_BOTTOMLEFT);
            this._bottomRight = new cc.Sprite;
        ...
        var batchNode = cc.SpriteBatchNode.create(spriteFrame.getTexture(),
            9);
        var locLoaded = spriteFrame.textureLoaded();
        this._textureLoaded = locLoaded;
        if (!locLoaded)spriteFrame.addLoadedEventListener(function (sender) {
        ...
        this.updateWithBatchNode(batchNode,
            spriteFrame.getRect(), cc._renderType == cc._RENDER_TYPE_WEBGL && spriteFrame.isRotated(), cc.rect(0, 0, 0, 0));
        this._insetLeft = 0;
        this._insetTop = 0;
        this._insetRight = 0;
        this._insetBottom = 0
