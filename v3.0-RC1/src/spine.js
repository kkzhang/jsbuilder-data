...
sp.SkeletonAnimation = sp.Skeleton.extend({_state: null, _target: null, _callback: null, ctor: function (skeletonDataFile, atlasFile, scale) {
    ...
    return this._state.setAnimation(trackIndex,
        animation, loop)
